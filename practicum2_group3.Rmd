...
CREATE TABLE ArticleFact (
  ...
  PubDate       TEXT NOT NULL,
  CitedMedium   TEXT NOT NULL,
  PRIMARY KEY (ISSN, AuthorID, HistoryID),
...
INSERT INTO ArticleAuthorSummaryFact
  SELECT AF.AuthorID AS AuthorID,
         ...
         COUNT(*) AS ArticleNumber
    FROM (SELECT DISTINCT ISSN, AuthorID, HistoryID FROM ArticleFact) AF
...
1. Count number of articles per time year by author
...
2. Count number of articles per time year by journal
