...
ggplot(data, aes(x = month)) +
  ...
  geom_line(aes(y = num_accepted, color = "Accepted")) +
  scale_color_manual(name = "Legend", values = c("Submitted" = "red", "Accepted" = "blue")) +
  labs(title = "Number of Articles Submitted and Accepted over Time",
       x = "Time Period",
       y = "Number of Articles")
```
